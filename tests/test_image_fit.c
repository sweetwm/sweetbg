...
static int test_contain_wide(void) {
	struct caramel_placement p;
	caramel_contain_rects(2000, 1000, 1000, 1000, &p);
...
static int test_contain_tall(void) {
	struct caramel_placement p;
	caramel_contain_rects(1000, 2000, 1000, 1000, &p);
	CHECK(p.dst.h == 1000);
	CHECK(p.dst.w == 500);
	CHECK(p.dst.y == 0);
	CHECK(p.dst.x == 250);
...
static int test_center_smaller(void) {
	struct caramel_placement p;
	caramel_center_rects(400, 200, 1000, 1000, &p);
...
static int test_center_larger(void) {
	struct caramel_placement p;
	caramel_center_rects(3000, 3000, 1000, 1000, &p);
